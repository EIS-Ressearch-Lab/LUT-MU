...
This repository shows **training** and **deployment** example of using LUT-MU based NN models proposed in paper *Mitigating scalability challenges in LUT-based neural networks via pruning optimisations*.

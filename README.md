...
Compared to original MADDNESS-based neural networks, our LUT-MU shows $1.3$ to $2.6\times$ resource savings based on various resolution configuration settings of MADDNESS.
...
This is repository shows **training** and **deployment** example of using LUT-MU based NN models. 

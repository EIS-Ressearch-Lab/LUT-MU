...
This repository shows **training** example of LUT-MU based NN models proposed in paper *Mitigating scalability challenges in LUT-based neural networks via pruning optimisations* [arxiv](https://arxiv.org/abs/2407.02362).
